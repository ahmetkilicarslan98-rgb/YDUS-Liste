...
- **Pomodoro**: odak, kısa mola ve uzun mola süreleri hem zamanlayıcı ekranındaki
  +/- düğmelerinden hem de Ayarlar sekmesinden değiştirilir. Varsayılan 50 dakika çalışma
  ve 15 dakika moladır. 25/5, 50/15 ve 90/20 hazır kalıpları tek dokunuşla uygulanır, uzun mola aralığı seçilir, süre bitince otomatik
